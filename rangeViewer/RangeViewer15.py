...
# Initial obstructions for testing
    ...
    for event in pygame.event.get():
        ...
        if not consumed_event:
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if hex_pos:
                    if event.button == 1:  # Left click to move center
                    ...
                    elif event.button == 2:  # Middle click to clear obstacle
                        ...
                        current_range = calculate_range(hex_grid, hex_grid.selected_hex or center_pos, 
                                                        ...
                                                        pattern_dropdown.selected_option, 
                                                        include_pos_state, exclude_adj_state)
                    elif event.button == 3:  # Right click to toggle obstacle or drag
                        if not dragging:
