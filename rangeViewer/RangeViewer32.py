...
def calculate_range(grid, pos, distance, pattern, include_pos, exclude_adj):
    ...
    if pattern == "Mist/Shadow":
        ...
        # Step tables for even and odd columns
        steps_even = {
            30: [(6, 13), (5, 14), (3, 15), (2, 16)],
            150: [(9, 13), (11, 14), (12, 15), (14, 16)],
            210: [(9, 11), (11, 10), (12, 9), (14, 8)],
            330: [(6, 11), (5, 10), (3, 9), (2, 8)]
        }
        steps_odd = {
            30: [(5, 12), (4, 13), (2, 14), (1, 15)],
            150: [(8, 12), (10, 13), (11, 14), (13, 15)],
            210: [(8, 10), (10, 9), (11, 8), (13, 7)],
            330: [(5, 10), (4, 9), (2, 8), (1, 7)]
        }
            ...
            if angle == 90:
                for step in range(1, dist + 1):
                    ...
                    if (0 <= new_r < grid.rows and 0 <= new_c < grid.cols and 
                        grid.hex_distance(pos, (new_r, new_c)) <= dist):
                        line.append((new_r, new_c))
                    else:
                        break
            elif angle == 270:
                for step in range(1, dist + 1):
                ...
                # Use step table based on column parity
                steps = steps_even[angle] if is_even_col else steps_odd[angle]
                for step_idx in range(min(dist, len(steps))):
                    dr, dc = steps[step_idx][0] - row, steps[step_idx][1] - col
